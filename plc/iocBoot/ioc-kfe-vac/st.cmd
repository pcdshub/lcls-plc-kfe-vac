...
epicsEnvSet("LOCATION", "PLC:KFE:VAC:K0" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:KFE:VAC:K0")
dbLoadRecords("save_restoreStatus.db", "P=PLC:KFE:VAC:K0:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:KFE:VAC:K0")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:KFE:VAC:K0")
...
save_restoreSet_status_prefix( "PLC:KFE:VAC:K0:" )
