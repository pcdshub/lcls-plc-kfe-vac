...
"C:/Program Files/Docker/Docker/resources/bin/docker.exe" run ^
	...
	-i pcdshub/ads-deploy:latest ^
        "make -C ${ADS_IOC_PATH}/iocBoot/templates && cd '/reg/g/pcds/epics/ioc/plc-kfe-vac/iocBoot/ioc-plc-kfe-vac' && make && sed -i '/^adsIoc_registerRecord.*$/a adsSetLocalAddress(172.21.42.126.1.1)' st.cmd && ./st.cmd; echo 'IOC exited.'; sleep 1"
pause
