...
epicsEnvSet("LOCATION", "IOC:PLC:KFE:VAC:K0" )
...
dbLoadRecords("iocSoft.db", "IOC=IOC:PLC:KFE:VAC:K0")
dbLoadRecords("save_restoreStatus.db", "P=IOC:PLC:KFE:VAC:K0:")
...
save_restoreSet_status_prefix( "IOC:PLC:KFE:VAC:K0:" )
